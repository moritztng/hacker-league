        ...
        // init vulkan
        {
            ...
            }
            {
                ...
                faces = {
                    ...
                    {{8, 9, 10, 11}, {0.0f, 0.0f, 1.0f}},
                    {{12, 13, 14, 15}, {0.0f, 0.0f, 1.0f}},
                    {{11, 15, 16, 17}, {0.0f, 0.0f, 1.0f}},
                    {{18, 19, 20, 21}, {0.0f, 0.0f, -1.0f}},
                    {{22, 23, 24, 25}, {0.0f, 0.0f, -1.0f}},
                    {{21, 25, 26, 27}, {0.0f, 0.0f, -1.0f}},
                };
